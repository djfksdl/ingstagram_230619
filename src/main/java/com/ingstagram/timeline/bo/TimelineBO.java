package com.ingstagram.timeline.bo;
...
public class TimelineBO {
	...
	public List<CardView> generateCardViewList(Integer userId){
		...
		//글 목록 반복문 순회
		//postEntiy -> CardView  -> cardViewList에 담는다.
		for (PostEntity post : postList) { // 0 1 2
			...
			//글쓴이 정보 세팅
			UserEntity user = userBO.getUsesrEntityById(post.getUserId());
