...
<div class="d-flex justify-content-center">
	<div class="sign-up-box">
		...
		<form id="signUpForm" method="post" action="/user/sign-up" class="bg-light p-5">
			<span class="sign-up-subject">ID</span>
			<%-- 인풋 옆에 중복확인 버튼을 옆에 붙이기 위해 div 만들고 d-flex --%>
			<div class="d-flex mt-3">
				<input type="text" id="loginId" name="loginId" class="form-control col-8 mr-2" placeholder="ID를 입력해주세요">
